...
export default class SimulationDashboard extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <Container style={{ paddingBottom: 30, paddingTop: 15 }}>
          <Stack direction="horizontal" gap={3}>
            ...
            <Button variant="danger" onClick={this.resetConfig}>Reset Config</Button>{" "}
            {resultsLoaded && (
          ...
          {viewResults && (
            <PlotlyChart data={this.state.dataPoints}></PlotlyChart>
          )}
        </Container>
      </div>
    );
